...
2. Ask me for:
   ...
   - Link(s) to requirements documentation (don't read it, but suggest `.current_agent_context/requirements.md` to me if it exists)
...
5. Discuss with me the right number of units of work (features) that we want to divide the work into. Provide a recommendation. User stories is a possible approach we might consider.
