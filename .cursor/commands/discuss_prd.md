# Guided PRD Creation (with User-centered Checks)
...
Collaborate with me to create a comprehensive draft Product Requirements Document (PRD.md) for a new product/feature through an iterative, question-driven process, ensuring alignment with my vision at each stage.

## PROCESS & KEY RULES

1. Before we start, I will first provide you will provide an initial "brain dump". This might be incomplete or unstructured.
