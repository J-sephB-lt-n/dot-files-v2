...
We are now going to decompose the epic defined in /docs/current_epic/epic_requirements.md into user stories (individual self-contained units of developer work). You may explore the codebase a little on your own to get any further context you may need to perform this task.
...
[
  {
    ...
    "status": "NOT_STARTED",
    "last_updated_at": "UTC datetime string in ISO 8601 format"
  },
  ...
]
```
...
Do a git commit with an organised commitizen-style commit message.
